...
if __name__ == '__main__':
    ...
    try:
        ...
        #fname = glob("../work/dlab-finance/local_data/EQY_US_ALL_BBO_*.zip")[0]
    ...
    max_price = max(Ask_Price)

    #find the min Ask price
    min_price = min(Ask_Price)

    #find the mean of Ask price
    avg_price = np.mean(Ask_Price)

    #find the mod of Ask price
    mod_price = mode(Ask_Price)

    #find the sd of Ask price
    sd_price = np.std(Ask_Price)
